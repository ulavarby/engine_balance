...
'''Script for calculation of the dynamic balance of reciprocating and
...
def visualization():
    ...
    ax1.set_ylabel('P1, [N]')
    ax1.set_title('1st order reciprocating forse')
    ...
    ax2.set_ylabel('P2, [N]')
    ax2.set_title('2nd order reciprocating forse')
...
def visualization_max():
    ...
    for k in range(1,7):
        ...
        for bar in bark:
            ...
            height), xytext=(0, 0), textcoords='offset points', ha='center',
